...
"""
ESG EXPORT INSIGHT - 최종 HTML 생성 스크립트 (APA 방식 출처)
"""
...
from fetch_data_crawling_apa import (
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <div class="update-badge">✓ 2026-01-21 업데이트 (신뢰도 100% | APA 방식 출처)</div>
        </div>
...
if __name__ == '__main__':
    ...
    print(f"✨ 기관명 정확화 완료 (KOTRA, KITA 등)")
