...
정확한 출처 URL 매핑 + SPA 네비게이션 + 다양한 시각화
"""
...
from fetch_data_crawling_final import (
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <div class="update-badge">✓ 2026-01-21 업데이트</div>
        </div>
    ...
    for nav_id, section in zip(nav_ids, sections):
        ...
        <div class="section {active_class}" id="{nav_id}">
            <div class="section-header">
                <h2>{section['title']}</h2>
                <div class="confidence-badge">신뢰도: 98%</div>
            </div>
'''
